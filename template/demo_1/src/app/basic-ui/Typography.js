                    ...
                    <div className="row">
                      <div className="col-md-4 d-flex align-items-center">
                        <div className="d-flex flex-row align-items-center">
                          <i className="icon-compas icon-lg text-warning"></i>
                          <p className="mb-0 ml-1"> Icon-lg </p>
                        </div>
                      </div>
                      <div className="col-md-4 d-flex align-items-center">
                        <div className="d-flex flex-row align-items-center">
                          <i className="icon-compas icon-md text-success"></i>
                          <p className="mb-0 ml-1"> Icon-md </p>
                        </div>
                      </div>
                      <div className="col-md-4 d-flex align-items-center">
                        <div className="d-flex flex-row align-items-center">
                          <i className="icon-compas icon-sm text-danger"></i>
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <div className="media">
                  <i className="icon-globe icon-md text-info d-flex align-self-start mr-3"></i>
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <div className="media">
                  <i className="icon-globe icon-md text-info d-flex align-self-center mr-3"></i>
                  <div className="media-body">
                    <p className="card-text">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque.</p>
                  </div>
                </div>
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <div className="media">
                  <i className="icon-globe icon-md text-info d-flex align-self-end mr-3"></i>
                  <div className="media-body">
                    <p className="card-text">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque.</p>
                  </div>
                </div>
          ...
          <div className="col-md-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-description"> Use class<code>.font-weight-semibold</code>
                </p>
                <p> It is a long <span className="font-weight-semibold">established fact</span> that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution </p>
              </div>
            </div>
          </div>
          <div className="col-md-6 grid-margin stretch-card">
